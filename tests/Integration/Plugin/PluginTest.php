...
class PluginTest extends \WP_UnitTestCase {
	...
	/**
	 * Tests that init() registers convert_auth_to_azure at priority 15 on the init hook.
	 */
	public function test_init_registers_convert_auth_to_azure_at_priority_15(): void {
		$this->plugin->init();
		$this->assertSame(
			15,
